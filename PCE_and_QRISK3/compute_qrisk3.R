...
QRISK_female = t(sapply(1:nrow(females), function(i) with(females,
                                                          QRiskFemale(age = age_attending.0.0[i],
                                                                      b_AF = AF[i], 
...
QRISK_male = t(sapply(1:nrow(males), function(i) with(males,
                                                      QRiskMale(age = age_attending.0.0[i],
                                                                b_AF = AF[i], 
                                                                b_atypicalantipsy = atypicals[i], 
                                                                b_corticosteroids = steroid_use[i],
                                                                b_impotence2=ED[i],
...
apply(mytable_qrisk, 2, FUN=function(x){sum(is.na(x))})
